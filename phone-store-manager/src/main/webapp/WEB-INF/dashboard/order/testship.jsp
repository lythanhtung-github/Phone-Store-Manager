            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card card-table">
                        <div class="card-header">Danh sách đơn hàng xác nhận</div>
                                ...
                                <tbody>
                                    ...
                                    <c:forEach var="orderDTO" items="${requestScope.listOrderDTO}">
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="text-center">
                                                <a href="/order?action=toship&id=${orderDTO.getId()}" class="btn btn-warning">
                                                    <i class="mdi mdi-local-shipping"></i>
                                                </a>
                                            </td>
                                        </tr>
                                    </c:forEach>
