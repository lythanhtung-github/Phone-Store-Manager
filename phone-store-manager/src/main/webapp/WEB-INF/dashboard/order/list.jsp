                    ...
                    <div class="card card-table">
                        ...
                        <div id="table4_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                            <div class="row be-datatable-header">
                                <form action="/order" method="get" style="display: flex;" class="col-12">
                                        ...
                                        <div>
                                            <select name="statusId" class="form-control">
                                                ...
                                                <c:forEach items="${applicationScope.listStatus}" var="status">
                                                    <option
                                                            <c:if test="${requestScope.statusId == status.getId()}">selected</c:if>
                                                            value="${status.getId()}">${status.getType()}
                                                    </option>
                                                </c:forEach>
                                            </select>
                                        </div>
                            ...
                            <table class="table table-striped table-hover table-fw-widget" id="table4">
                                ...
                                <c:forEach var="orderDTO" items="${requestScope.listOrderDTO}">
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="text-center">
                                            <a href="/order?action=view&id=${orderDTO.getId()}" type="button"
