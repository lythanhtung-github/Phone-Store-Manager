                        ...
                        <form method="post" style="display:flex">
                            <div class="card-body col-md-7">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input class="form-control" id="price" name="price" type="number" min="500000"
                            ...
                            <textarea class="form-control" rows="4" id="description" name="description"
                                      value="${requestScope.product.getDescription()}"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <button class="btn btn-space btn-success col-12 col-sm-6" type="submit"
                                        ...
                                        <span class="mdi mdi-plus-square"> Thêm sản phẩm</span>
                                    </button>
                                </div>
                            </div>
                            <div class="card-body col-md-7">
                                <div class="form-group row">
                                    <img id="imageProduct"
                                         src="https://cdn.hoanghamobile.com/i/productlist/dsp/Uploads/2022/02/09/image-removebg-preview-7.png"
                                         alt="">
                                </div>
                            </div>
                        </form>
