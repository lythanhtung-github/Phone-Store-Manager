      ...
      <div class="left-sidebar-scroll">
        <div class="left-sidebar-content">
          <ul class="sidebar-elements">
            ...
            <li class="parent"><a href="#"><i class="icon mdi mdi-chart"></i><span>Thống kê</span></a>
              <ul class="sub-menu">
                <li><a href="#"><span class="badge badge-primary float-right">New</span>Ngày</a>
                </li>
                <li><a href="#"><span class="badge badge-primary float-right">New</span>Tháng</a>
                </li>
                <li><a href="#"><span class="badge badge-primary float-right">New</span>Năm</a>
                </li>
              </ul>
            </li>
            <li class="parent"><a href="#"><i class="icon mdi mdi-accounts-outline"></i><span>Quản lý nhân
                      viên</span></a>
              <ul class="sub-menu">
